...
class ClothesPageGalleryImage(Orderable):
    page = ParentalKey(ClothesPage, on_delete=models.PROTECT, related_name='gallery_images')
    image = models.ForeignKey(
